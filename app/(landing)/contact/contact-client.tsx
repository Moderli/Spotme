      ...
      <main className="flex-grow">
                ...
                <div className="bg-surface-container-high p-10 rounded-[32px] soft-lift space-y-10 border border-outline-variant/20">
                  ...
                  <div>
                    ...
                    <div className="flex gap-6">
                      <a className="w-12 h-12 rounded-full bg-surface-bright flex items-center justify-center text-primary hover:bg-primary hover:text-on-primary transition-colors duration-300 shadow-sm" href="#">
        ...
        <section className="h-[400px] relative w-full overflow-hidden reveal-section">
          <div className="absolute inset-0 z-0">
            <img
              className="w-full h-full object-cover"
              alt="Scenic view near Hyderabad, India — Spotme office location"
